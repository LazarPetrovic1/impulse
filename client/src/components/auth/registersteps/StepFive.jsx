...
const { agreewithterms, looksgood, agreement } = registercomponent;
  ...
  return (
    <Fragment>
      <TermsConditions className="container-md">
        ...
        <p>Welcome to Impulse!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Impulse, DOO's Website, located at https://impulse.io.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Impulse if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Impulse, you agreed to use
          cookies in agreement with the Impulse, DOO's Privacy Policy.{" "}
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, Impulse, DOO and/or its licensors own the
          intellectual property rights for all material on Impulse. All
          intellectual property rights are reserved. You may access this from
          Impulse for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from Impulse</li>
          <li>Sell, rent or sub-license material from Impulse</li>
          <li>Reproduce, duplicate or copy material from Impulse</li>
          <li>Redistribute content from Impulse</li>
        </ul>
        <p>
        ...
        <p>
          ...
          Impulse, DOO does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Impulse, DOO,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Impulse, DOO
          shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          Impulse, DOO reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant Impulse, DOO a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Impulse, DOO; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Impulse, DOO. Please include your name, your
        ...
        <p>
          No use of Impulse, DOO's logo or other artwork will be allowed for
      ...
      <div className="d-flex justify-content-end">
        <button
          ...
          onClick={() => onProgressChange([check])}
        >
