...
function TermsAndConditions() {
  return (
    <div
      className="py-3 px-5"
      style={{ overflow: "auto", height: "calc(100vh - 86px)" }}
    >
      <h2>
      ...
      <p>
        ...
        of Impulse, DOO's Website, located at https://impulse.io.
      </p>
      <p>
      ...
      <p>
        ...
        Impulse for your own personal use subjected to restrictions set in these
      ...
      <p>
        ...
        Impulse, DOO does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Impulse, DOO,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Impulse, DOO shall not be
      ...
      <p>
        You hereby grant Impulse, DOO a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Impulse, DOO; and (d) the link
      ...
      <p>
        ...
        e-mail to Impulse, DOO. Please include your name, your organization
