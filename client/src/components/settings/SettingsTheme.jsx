    ...
    <Fragment>
      <div className="form-check form-check-inline ml-4">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "impulse"
          }
        />
        <label
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "impulseplus"
          }
        />
        <label
          className="form-check-label"
      ...
      <div className="form-check form-check-inline">
        ...
        />
        <label className="form-check-label" htmlFor="dark" style={style.label}>
          {_dark[language]}
        </label>
      </div>
      <div className="form-check form-check-inline">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "neuralcore"
          }
        />
        <label
          className="form-check-label"
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "fireworks"
          }
        />
        <label
          className="form-check-label"
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "interstellar"
          }
        />
        <label
          className="form-check-label"
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "painter"
          }
        />
        <label
          className="form-check-label"
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "photons"
          }
        />
        <label
          className="form-check-label"
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          onClick={onClick}
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "rainbow"
          }
        />
        <label
          className="form-check-label"
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          value="inferno"
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "inferno"
          }
          onClick={onClick}
        />
        <label
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          value="fountain"
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "fountain"
          }
          onClick={onClick}
        />
        <label
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          value="network"
          checked={
            JSON.parse(localStorage.getItem("isDarkTheme")) === "network"
          }
          onClick={onClick}
        />
        <label
