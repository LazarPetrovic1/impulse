...
export const forumPostEditComment = (id, comment_id, content) => async (
  dispatch
) => {
  const config = {
    headers: {
  ...
  try {
    const res = await axios.put(
      `/api/forumposts/comment/${id}/${comment_id}`,
      JSON.stringify({ content }),
      config
    );
...
export const forumPostReplyToComment = (id, comment_id, content) => async (
  dispatch
) => {
  const config = {
    headers: {
  ...
  try {
    const res = await axios.post(
      `/api/forumposts/comment/${id}/${comment_id}/reply`,
      JSON.stringify({ content }),
      config
    );
    dispatch({
...
export const forumPostDeleteReplyToComment = (
  id,
  comment_id,
  reply_id
) => async (dispatch) => {
  try {
    await axios.delete(
      `/api/forumposts/comment/${id}/${comment_id}/${reply_id}`
    );
    const payload = {
      comment_id,
      reply_id,
...
export const forumPostEditReplyToComment = (
  id,
  comment_id,
  reply_id,
  replyText
...
export const impulsifyForumPostComment = (id, commentId, likerId) => async (
  dispatch
) => {
  const body = JSON.stringify({ likerId });
  const config = { headers: { "Content-Type": "application/json" } };
  try {
    const res = await axios.put(
      `/api/forumposts/${id}/${commentId}/impulse`,
      body,
      config
    );
    dispatch({
...
export const likeForumPostComment = (id, commentId, likerId) => async (
  dispatch
) => {
  const body = JSON.stringify({ likerId });
  const config = { headers: { "Content-Type": "application/json" } };
  try {
    const res = await axios.put(
      `/api/forumposts/${id}/${commentId}/like`,
      body,
      config
    );
...
export const dislikeForumPostComment = (id, commentId, likerId) => async (
  dispatch
) => {
  const body = JSON.stringify({ likerId });
  const config = { headers: { "Content-Type": "application/json" } };
  try {
    const res = await axios.put(
      `/api/forumposts/${id}/${commentId}/dislike`,
      body,
      config
    );
    dispatch({
...
export const impulsifyReplyToForumPostComment = (
  id,
  commentId,
  replyId,
  likerId
  ...
  try {
    const res = await axios.put(
      `/api/forumposts/${id}/${commentId}/${replyId}/impulse`,
      body,
      config
    );
    dispatch({
...
export const likeReplyToForumPostComment = (
  id,
  commentId,
  replyId,
  likerId
  ...
  try {
    const res = await axios.put(
      `/api/forumposts/${id}/${commentId}/${replyId}/like`,
      body,
      config
    );
    dispatch({
...
export const dislikeReplyToForumPostComment = (
  id,
  commentId,
  replyId,
  likerId
  ...
  try {
    const res = await axios.put(
      `/api/forumposts/${id}/${commentId}/${replyId}/dislike`,
      body,
      config
    );
    dispatch({
