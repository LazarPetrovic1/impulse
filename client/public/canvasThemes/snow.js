...
const irand = (min, max) => Math.floor((min||0) + Math.random() * ((max+1||100) - (min||0)));
...
window.addEventListener('resize', function() {
    ...
    jsCanvasSnow.init("canvas", options );
}, false);
...
window.addEventListener('load', function() {
  ...
  var options = {
    ...
    'amplitude' : [30, 50],
    'alpha' : [0.1,0.95],
    'images' : ["https://i.imgur.com/jbSVFgy.png", "https://i.imgur.com/TT2lmN4.png","https://i.imgur.com/do8589m.png","https://i.imgur.com/3BxEO8i.png"]
  };
